...
> **Note:** The Ruby driver is not officially supported on Windows.
...
Navigate into the `ruby/hello-world` project directory, then install
dependencies:

```bash
cd docs-get-started/ruby/hello-world
bundle install
```
